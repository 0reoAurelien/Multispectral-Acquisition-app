...
[mixedsig, mixedmean] = MultispectralViewerPkg.DisplayICA.remmean(mixedsig);
...
if jumpWhitening == 3
  ...
  if jumpPCA == 2,
    ...
    % Calculate PCA
    [E, D]=MultispectralViewerPkg.DisplayICA.pcamat(mixedsig, firstEig, lastEig, interactivePCA, verbose);
  end
end
...
if only > 1
  ...
  if jumpWhitening == 3,
    ...
    [whitesig, whiteningMatrix, dewhiteningMatrix] = MultispectralViewerPkg.DisplayICA.whitenv ...
...
if only > 2
  ...
  [A, W] = MultispectralViewerPkg.DisplayICA.fpica (whitesig,  whiteningMatrix, dewhiteningMatrix, approach, ...
